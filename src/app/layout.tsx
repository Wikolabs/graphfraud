...
export const metadata: Metadata = { title:"GraphFraud — Detection de reseaux de fraude par graphes IA", description:"Decouvrez les anneaux de fraude organises que les methodes classiques ne voient pas. GraphFraud analyse les connexions entre entites et detecte les reseaux frauduleux coordonnes." };
