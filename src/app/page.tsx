    ...
    <main style={{ fontFamily: "var(--font-body)" }}>
      ...
      <nav style={{ background: "#fff", borderBottom: "1px solid #ffe4e6", padding: "0 2rem", display: "flex", alignItems: "center", justifyContent: "space-between", height: "64px", position: "sticky", top: 0, zIndex: 50 }}>
        ...
        <div style={{ display: "flex", gap: "1.5rem", alignItems: "center" }}>
          ...
          <a href="https://calendly.com/wikolabs" target="_blank" rel="noopener noreferrer" style={{ background: "#f43f5e", color: "#fff", padding: "0.5rem 1.25rem", borderRadius: "8px", textDecoration: "none", fontSize: "0.9rem", fontWeight: 600 }}>Démo gratuite</a>
        </div>
      </nav>
      ...
      <section style={{ background: "linear-gradient(135deg, #fff1f2 0%, #ffe4e6 100%)", padding: "5rem 2rem 4rem", textAlign: "center" }}>
        ...
        <div style={{ display: "flex", gap: "1rem", justifyContent: "center", flexWrap: "wrap", marginBottom: "3.5rem" }}>
          <a href="https://calendly.com/wikolabs" target="_blank" rel="noopener noreferrer" style={{ background: "#f43f5e", color: "#fff", padding: "0.85rem 2rem", borderRadius: "10px", textDecoration: "none", fontWeight: 700, fontSize: "1rem" }}>Demander une démo</a>
      ...
      <section style={{ padding: "5rem 2rem", background: "#f43f5e", textAlign: "center" }}>
        ...
        <div style={{ display: "flex", gap: "1rem", justifyContent: "center", flexWrap: "wrap" }}>
          <a href="https://calendly.com/wikolabs" target="_blank" rel="noopener noreferrer" style={{ background: "#fff", color: "#f43f5e", padding: "0.9rem 2.25rem", borderRadius: "10px", textDecoration: "none", fontWeight: 700, fontSize: "1rem" }}>Planifier une démo</a>
